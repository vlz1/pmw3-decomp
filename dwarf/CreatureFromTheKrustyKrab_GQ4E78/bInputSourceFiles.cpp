/*
    Compile unit: b:/BlitzSDK/Babel/GameCube/Src/bInput/bInputSourceFiles.cpp
    Producer: GNU C++ 2.95.3 SN BUILD v1.62 for Nintendo Gamecube
    Compile directory: b:\BlitzSDK\Babel\GameCube\Src\bInput
    Language: C++
    Code range: 0x802481D4 -> 0x80249024
    GCC Source File Name Offset: 0x0001B5B7
    GCC Source Info Offset: 0x0004E2AC
*/
...
// Range: 0x802481D4 -> 0x8024821C
void bInitInputHAL(unsigned int flags /* r3 */) {}

// Range: 0x8024821C -> 0x80248220
void bShutdownInputHAL() {}

// Range: 0x80248220 -> 0x802485A4
static void bPadCopy(struct PADStatus * padRead /* r3 */, int n /* r4 */) {
    // Local variables
    struct _TPadPortInfo * pad; // r31
    int x; // r11
    int y; // r9
    int aClampedMin; // r9
    int aClampedMax; // r10
...
// total size: 0x80
struct _TPadPortInfo {
    // Members
    int iLeft; // offset 0x0, size 0x4
    int iRight; // offset 0x4, size 0x4
    int iUp; // offset 0x8, size 0x4
    int iDown; // offset 0xC, size 0x4
    int iX1; // offset 0x10, size 0x4
    int iY1; // offset 0x14, size 0x4
    int iX2; // offset 0x18, size 0x4
    int iY2; // offset 0x1C, size 0x4
    int iA; // offset 0x20, size 0x4
    int iB; // offset 0x24, size 0x4
    int iAPress; // offset 0x28, size 0x4
    int iBPress; // offset 0x2C, size 0x4
    int iL; // offset 0x30, size 0x4
    int iR; // offset 0x34, size 0x4
    int iLTrigger; // offset 0x38, size 0x4
    int iRTrigger; // offset 0x3C, size 0x4
    int iX; // offset 0x40, size 0x4
    int iY; // offset 0x44, size 0x4
    int iZ; // offset 0x48, size 0x4
    int iStart; // offset 0x4C, size 0x4
    int iReset; // offset 0x50, size 0x4
    int type; // offset 0x54, size 0x4
    int valid; // offset 0x58, size 0x4
    int rumbleActive; // offset 0x5C, size 0x4
    unsigned long long rumbleOffTime; // offset 0x60, size 0x8
    unsigned long long rumbleCount; // offset 0x68, size 0x8
    unsigned long long resetTime; // offset 0x70, size 0x8
    unsigned long long connectTime; // offset 0x78, size 0x8
};
// Range: 0x802485A4 -> 0x802488F8
void bReadPhysicalInputDevices(int wait /* r3 */) {
    // Local variables
    int i; // r28
    int validPads;
    int reset; // r24
    ...
    /* anonymous block */ {
        // Range: 0x802485DC -> 0x80248630
        int i;
    }

    /* anonymous block */ {
        // Range: 0x80248650 -> 0x80248824
        int oldType; // r27
        int type; // r3
    }
}

// Range: 0x802488F8 -> 0x80248BD4
int bReadInput(int inputID /* r3 */, int behaviour /* r4 */, int * valuePtr /* r5 */) {
    // Local variables
    int port; // r6
    int gain; // r7
    int value; // r0
    int invert; // r12
    int circular; // r10
    struct _TPadPortInfo * pad; // r0
    struct PADStatus * padRead;
}

// Range: 0xFFFFFFFF -> 0x80248BD4
int biFindPad(int index /* r3 */) {
    // Local variables
    int port; // r11
}

// Range: 0x80248BD4 -> 0x80248D9C
int biFFSetParm(int devId /* r3 */, int parm /* r4 */, ...) {
    // Local variables
    int value; // r9
    struct __va_list_tag argp[1]; // r1+0x70

    /* anonymous block */ {
        // Range: 0x80248C84 -> 0x80248CF0
        int * __ptr; // r10
    }
}

// Range: 0x80248D9C -> 0x80248F38
void bUpdateRumble(unsigned long long lastFrameTime /* r23 */) {
    // Local variables
    int padId; // r26
}
...
// Range: 0xFFFFFFFF -> 0x80248F38
enum EBIDeviceType biQueryDevice(int portID /* r3 */, void * infoBuffer /* r4 */) {}
...
// Range: 0x80248F38 -> 0x80248FB4
void biFFStop(int padId /* r31 */) {}
...
// Range: 0xFFFFFFFF -> 0x80248FB4
enum EBPortStatus biGetPortStatus(int portId /* r3 */) {}

// Range: 0x80248FB4 -> 0x80248FF4
int bResetPressed() {
    // Local variables
    int port;
}

// Range: 0x80248FF4 -> 0x80249024
void bResetDebounce() {
    // Local variables
    int port;
}
...
int bSoftwareResetEnabled; // size: 0x4, address: 0x8047CEF0
enum EBIChannelType {
...
TBInputStateInfo bInputState; // size: 0x4
enum EBGameSaveMode {
    BGAMESAVE_LOAD = 0,
    BGAMESAVE_SAVE = 1,
    BGAMESAVE_DELETE = 2,
...
typedef struct _TPadPortInfo TPadPortInfo;
static PADStatus padState[4]; // size: 0x30, address: 0x8042B048
static TPadPortInfo padInfo[4]; // size: 0x200, address: 0x8042B078
static unsigned long PadChanMask[4]; // size: 0x10, address: 0x80384EE0
unsigned int bInputLastFlipCount; // size: 0x4, address: 0x8047D670
