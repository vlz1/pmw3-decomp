/*
    Compile unit: b:/BlitzSDK/Babel/GameCube/Src/fEffects/fEffectsSourceFiles.cpp
    Producer: GNU C++ 2.95.3 SN BUILD v1.62 for Nintendo Gamecube
    Compile directory: b:\BlitzSDK\Babel\GameCube\Src\fEffects
    Language: C++
    Code range: 0x802D4FC4 -> 0x802D664C
    GCC Source File Name Offset: 0x0001D28C
    GCC Source Info Offset: 0x000774A4
*/
...
struct CBAnimSplashFX_Fade : public CBAnimSplashFX {
    ...
    CBAnimSplashFX_Fade(enum EBAnimSplashFXFade rFade, enum EBAnimSplashFXFade gFade, enum EBAnimSplashFXFade bFade, enum EBAnimSplashFXFade aFade);
    ...
    // Overrides: CBAnimSplashFX
    void Process(float processTime, struct CBAnimSplash * splash) override;

    // Overrides: CBAnimSplashFX
    unsigned int SetAttribMask() override;

    // Overrides: CBAnimSplashFX
    unsigned int ModAttribMask() override;
...
struct CBAnimSplash {
    // Functions
    CBAnimSplash(struct _TBTexture * texturePtr, struct CBAnimSplashFragGen * fragGenPtr);
    ...
    void SetAnim(float processTime, int render);

    int Enter();

    void Exit();

    int AddFX(struct CBAnimSplashFX * fxPtr);
    ...
    int Alloc(int noofAttr, int noofFrag);

    // Members
    union UBContext32 context; // offset 0x0, size 0x4
    ...
    struct CBAnimSplashRenderer renderer; // offset 0x54, size 0x6C
};
// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r30
CBAnimSplash::CBAnimSplash(struct _TBTexture * texturePtr /* r29 */, struct CBAnimSplashFragGen * fragGenPtr /* r28 */) {}
...
struct CBAnimSplashRenderer {
    ...
    void Render(struct CBAnimSplash * splash);

    // Members
    struct _TBCameraInstance * oldCamera; // offset 0x0, size 0x4
    ...
    float oldViewOrientation[4][4]; // offset 0x20, size 0x40
    float uScale; // offset 0x60, size 0x4
    float vScale; // offset 0x64, size 0x4
    struct _TBPrimVertex * verts; // offset 0x68, size 0x4
};
// total size: 0x24
struct TBAnimSplashAttrib {
    // Typedefs
    typedef struct TBAnimSplashAttrib ._164;
...
struct TBAnimSplashFragment {
    // Typedefs
    typedef struct TBAnimSplashFragment ._165;
...
// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r29
void CBAnimSplash::SetVisibleArea(int texWidth /* r31 */, int texHeight /* r30 */) {
    // Local variables
    int width; // r1+0x8
    int height; // r1+0xC
}
...
// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r31
void CBAnimSplash::SetAnim(float processTime /* f31 */, int render /* r30 */) {
    // Local variables
    int l; // r29
}
...
// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r3
int CBAnimSplash::AddFX(struct CBAnimSplashFX * fxPtr /* r4 */) {}

// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r3
void CBAnimSplash::SetDefaultPositions() {
    // Local variables
    int l; // r10
    struct TBAnimSplashAttrib * attr; // r11
}

// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r3
void CBAnimSplash::SetDefaultDiffuseRed() {
    // Local variables
    int l; // r11
    struct TBAnimSplashAttrib * attr; // r9
}

// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r3
void CBAnimSplash::SetDefaultDiffuseGreen() {
    // Local variables
    int l; // r11
    struct TBAnimSplashAttrib * attr; // r9
}
...
// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r3
void CBAnimSplash::SetDefaultDiffuseBlue() {
    // Local variables
    int l; // r11
    struct TBAnimSplashAttrib * attr; // r9
}
...
// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r3
void CBAnimSplash::SetDefaultDiffuseAlpha() {
    // Local variables
    int l; // r11
    struct TBAnimSplashAttrib * attr; // r9
}
...
// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r3
void CBAnimSplash::SetDefaultSpecularRed() {
    // Local variables
    int l; // r11
    struct TBAnimSplashAttrib * attr; // r9
}
...
// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r3
void CBAnimSplash::SetDefaultSpecularGreen() {
    // Local variables
    int l; // r11
    struct TBAnimSplashAttrib * attr; // r9
}
...
// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r3
void CBAnimSplash::SetDefaultSpecularBlue() {
    // Local variables
    int l; // r11
    struct TBAnimSplashAttrib * attr; // r9
}
...
// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r3
void CBAnimSplash::SetDefaultSpecularAlpha() {
    // Local variables
    int l; // r11
    struct TBAnimSplashAttrib * attr; // r9
}
...
// Range: 0xFFFFFFFF -> 0x802D4FC4
// this: r3
void CBAnimSplash::SetDefaultUV() {
    // Local variables
    int l; // r11
    struct TBAnimSplashAttrib * attr; // r9
}

// Range: 0x802D4FC4 -> 0x802D5054
// this: r31
int CBAnimSplash::Alloc(int noofAttr /* r28 */, int noofFrag /* r29 */) {}

// total size: 0x14
struct CBAnimSplashFragGen_Grid : public CBAnimSplashFragGen {
    // Functions
    CBAnimSplashFragGen_Grid(int xGridRes, int yGridRes, int xBreakVal);

    // Overrides: CBAnimSplashFragGen
    ~CBAnimSplashFragGen_Grid() override;

    // Overrides: CBAnimSplashFragGen
    int MakeFragments(struct CBAnimSplash * splash) override;
...
// Range: 0xFFFFFFFF -> 0x802D5054
// this: r9
CBAnimSplashFragGen_Grid::CBAnimSplashFragGen_Grid(int xGridRes /* r4 */, int yGridRes /* r5 */, int xBreakVal /* r6 */) {
    // Range: 0x802D5054 -> 0x802D5054
    inline CBAnimSplashFragGen::CBAnimSplashFragGen() {}
}

// Range: 0x802D5054 -> 0x802D5088
// Overrides: CBAnimSplashFragGen
// this: r3
CBAnimSplashFragGen_Grid::~CBAnimSplashFragGen_Grid() override {
    // Range: 0x802D5060 -> 0x802D5078
    inline virtual CBAnimSplashFragGen::~CBAnimSplashFragGen() {}
}

// Range: 0x802D5088 -> 0x802D53E0
// Overrides: CBAnimSplashFragGen
// this: r31
int CBAnimSplashFragGen_Grid::MakeFragments(struct CBAnimSplash * splash /* r30 */) override {
    // Local variables
    struct TBAnimSplashAttrib * attr; // r7
    int x; // r5
    int y; // r4
    float xFac; // f8
    float yFac; // f12
    struct TBAnimSplashFragment * frag; // r6
}

// Range: 0xFFFFFFFF -> 0x802D53E0
// this: r11
CBAnimSplashFX_Fade::CBAnimSplashFX_Fade(enum EBAnimSplashFXFade rFade /* r4 */, enum EBAnimSplashFXFade gFade /* r5 */, enum EBAnimSplashFXFade bFade /* r6 */, enum EBAnimSplashFXFade aFade /* r7 */) {
    // Range: 0x802D53E0 -> 0x802D53E0
    inline CBAnimSplashFX::CBAnimSplashFX() {}
}

// Range: 0x802D53E0 -> 0x802D5418
// Overrides: CBAnimSplashFX
// this: r3
void CBAnimSplashFX_Fade::Enter() override {}

// Range: 0x802D5418 -> 0x802D5448
// Overrides: CBAnimSplashFX
// this: r3
void CBAnimSplashFX_Fade::Exit() override {}

// Range: 0x802D5448 -> 0x802D5560
// Overrides: CBAnimSplashFX
// this: r3
void CBAnimSplashFX_Fade::Process(float processTime /* f1 */, struct CBAnimSplash * splash /* r4 */) override {
    // Local variables
    int l; // r8
    int val; // r10
    int sval; // r11
...
// Range: 0x802D5560 -> 0x802D55A8
// Overrides: CBAnimSplashFX
// this: r11
unsigned int CBAnimSplashFX_Fade::SetAttribMask() override {
    // Local variables
    unsigned int mask; // r3
}

// Range: 0x802D55A8 -> 0x802D55F4
// Overrides: CBAnimSplashFX
// this: r11
unsigned int CBAnimSplashFX_Fade::ModAttribMask() override {
    // Local variables
    unsigned int mask; // r3
}

// Range: 0xFFFFFFFF -> 0x802D55F4
// this: r9
CBAnimSplashFX_SlideOn::CBAnimSplashFX_SlideOn() {
    // Range: 0x802D55F4 -> 0x802D55F4
    inline CBAnimSplashFX::CBAnimSplashFX() {}
}

// Range: 0x802D55F4 -> 0x802D55F8
// Overrides: CBAnimSplashFX
// this: r3
void CBAnimSplashFX_SlideOn::Enter() override {}

// Range: 0x802D55F8 -> 0x802D55FC
// Overrides: CBAnimSplashFX
// this: r3
void CBAnimSplashFX_SlideOn::Exit() override {}

// Range: 0x802D55FC -> 0x802D57B8
// Overrides: CBAnimSplashFX
// this: r3
void CBAnimSplashFX_SlideOn::Process(float processTime /* f29 */, struct CBAnimSplash * splash /* r28 */) override {
    // Local variables
    int fragNum; // r29
    int attrNum; // r9
    struct TBAnimSplashAttrib * attr; // r31
    struct TBAnimSplashFragment * frag; // r30
    float xOff; // f30
    float yOff; // f1
    float ang; // f31
    float mat[4][4]; // r1+0x8

    // Range: 0x802D5628 -> 0x802D5628
    inline void bmVanillaSRand(unsigned int seed) {}

    // Range: 0x802D56B4 -> 0x802D56B4
    inline int bmVanillaRand() {}
...
// Range: 0x802D57B8 -> 0x802D57C0
// Overrides: CBAnimSplashFX
// this: r3
unsigned int CBAnimSplashFX_SlideOn::SetAttribMask() override {}

// Range: 0x802D57C0 -> 0x802D57C8
// Overrides: CBAnimSplashFX
// this: r3
unsigned int CBAnimSplashFX_SlideOn::ModAttribMask() override {}

// Range: 0xFFFFFFFF -> 0x802D57C8
// this: r9
CBAnimSplashRenderer::CBAnimSplashRenderer() {}
...
// Range: 0xFFFFFFFF -> 0x802D57C8
// this: r31
int CBAnimSplashRenderer::Enter() {}
...
// Range: 0xFFFFFFFF -> 0x802D57C8
// this: r3
void CBAnimSplashRenderer::SetUVScale(float u /* f1 */, float v /* f2 */) {}

// Range: 0xFFFFFFFF -> 0x802D57C8
// this: r29
void CBAnimSplashRenderer::Render(struct CBAnimSplash * splash /* r25 */) {
    // Local variables
    struct _TBPrimVertex * vert; // r8
    struct TBAnimSplashAttrib * attr; // r31
    struct TBAnimSplashFragment * frag; // r5
    int fragNum; // r11
    int attribsLeft; // r5
    int attribNum; // ctr
    int nextVert; // r26
...
struct CBFadeShadowProjector : public CBShadowProjector {
    ...
    struct CBShadowProjector : public CBProjector {
        ...
        struct CBProjector {
            ...
            // Functions
            CBProjector(enum EBProjectorControl control, unsigned int flags);
            ...
            void FocusOnActor(struct _TBActorInstance * actInstance, float * offset, int sticky);

            void SetFocus(float * focalPoint, int sticky);

            void SetFocus(float x, float y, float z);

            void SetPosition(float * pos, int sticky);

            void SetPosition(float x, float y, float z);

            void SetOrientation(float * xAngRadians, float * yAngRadians, float * zAngRadians, float dist);

            void SetOrientation(float xAngRadians, float yAngRadians, float zAngRadians, float dist);

            void SetOrientation(float * quatOrientation, float dist, int sticky);

            void SetOrientation(float (* orientation)[4], float dist, int sticky);

            void Update();

            void SetViewInfo(float xFovVal, float yFovVal, float nearClipVal, float farClipVal);

            void DrawMaskFrustum(float (* projView)[4]);
            ...
            float focus[4]; // offset 0x4, size 0x10
            float position[4]; // offset 0x14, size 0x10
            float orientation[4][4]; // offset 0x24, size 0x40
            float invOrientation[4][4]; // offset 0x64, size 0x40
            float distance; // offset 0xA4, size 0x4
            unsigned int projectorFlags; // offset 0xA8, size 0x4
            struct _TBActorInstance * focusActor; // offset 0xAC, size 0x4
            float focusOffset[4]; // offset 0xB0, size 0x10
            ...
            float projProjection[4][4]; // offset 0xEC, size 0x40
            ...
            float viewToProjector[4][4]; // offset 0x13C, size 0x40
            union UBContext32 context; // offset 0x17C, size 0x4
            const struct __vtbl_ptr_type * _vptr.CBProjector; // offset 0x180, size 0x4
        };

        // Functions
        CBShadowProjector(enum EBProjectorControl control, int xDim, int yDim, unsigned int flags, int bpp);

        // Overrides: CBProjector
        ~CBShadowProjector() override;

        void SetTarget(unsigned int clear);

        virtual void UnSetTarget();

        void PreDrawActorInstance(unsigned int flags);

        void DrawActorInstance(struct _TBActorInstance * actInstance, unsigned int alphaFlags, unsigned int flags);

        void PostDrawActorInstance(unsigned int flags);

        void SetShadowDensity(int density);

        // Overrides: CBProjector
        void Enable(int stage) override;

        void Enable(int stage, enum EBShadowProjectorStyle renderStyle, struct _TBRenderTarget * shadowTarget);

        // Overrides: CBProjector
        void SetRecievingGeometryMatrix(float (* m)[4]) override;

        // Overrides: CBProjector
        void Disable(int stage) override;

        // Members
        int createFlags; // offset 0x184, size 0x4
        struct _TBRenderTarget * target; // offset 0x188, size 0x4
        struct _TBActRenderMode_Shadow shadowParms; // offset 0x18C, size 0x10
        enum EBShadowProjectorStyle stageStyles[8]; // offset 0x19C, size 0x20
        struct _TBCameraInstance * oldCamera; // offset 0x1BC, size 0x4
        struct _TBOldCameraSettings oldSettings; // offset 0x1C0, size 0x5C
    };

    // Functions
    CBFadeShadowProjector(enum EBProjectorControl control, int xDim, int yDim);

    // Overrides: CBProjector
    ~CBFadeShadowProjector() override;

    void SetFadeTexture(struct _TBTexture * fadeTextureIn);
    ...
    // Overrides: CBShadowProjector
    void UnSetTarget() override;

    void ShowTargets();

    // Members
    struct _TBPrimVertex primVerts[4]; // offset 0x220, size 0x90
    struct _TBRenderTarget * fadeTarget; // offset 0x2B0, size 0x4
    struct _TBTexture * fadeTexture; // offset 0x2B4, size 0x4
};
// Range: 0xFFFFFFFF -> 0x802D57C8
// this: r30
CBFadeShadowProjector::CBFadeShadowProjector(enum EBProjectorControl control /* r4 */, int xDim /* r28 */, int yDim /* r29 */) {
    // Local variables
    int iw; // r1+0x8
    int ih; // r1+0xC
    float x; // f11
...
struct _TBOldCameraSettings {
    // Members
    float orientation[4][4]; // offset 0x0, size 0x40
...
// Range: 0x802D57C8 -> 0x802D581C
// Overrides: CBProjector
// this: r31
CBFadeShadowProjector::~CBFadeShadowProjector() override {}

// Range: 0xFFFFFFFF -> 0x802D581C
// this: r3
void CBFadeShadowProjector::SetFadeTexture(struct _TBTexture * fadeTextureIn /* r4 */) {}

// Range: 0x802D581C -> 0x802D5844
// Overrides: CBProjector
// this: r3
void CBFadeShadowProjector::Enable(int stage /* r4 */) override {}

// Range: 0x802D5844 -> 0x802D5864
// Overrides: CBProjector
// this: r3
void CBFadeShadowProjector::Disable(int stage /* r4 */) override {}

// Range: 0x802D5864 -> 0x802D59C4
// Overrides: CBShadowProjector
// this: r30
void CBFadeShadowProjector::UnSetTarget() override {}

// Range: 0xFFFFFFFF -> 0x802D59C4
// this: r30
void CBFadeShadowProjector::ShowTargets() {}

// Range: 0xFFFFFFFF -> 0x802D59C4
static void draw2DQuad(float x /* f1 */, float y /* f2 */, float w /* f3 */, float h /* f4 */, int r /* r3 */, int g /* r4 */, int b /* r5 */, int a /* r6 */, float s0 /* f5 */, float t0 /* f6 */, float s1 /* f7 */, float t1 /* f8 */) {
    // Local variables
...
// Range: 0xFFFFFFFF -> 0x802D59C4
// this: r31
CBProjector::CBProjector(enum EBProjectorControl control /* r4 */, unsigned int flags /* r30 */) {
    // Range: 0x802D59C4 -> 0x802D59C4
    inline void bmVanillaVectorSet(float * dest, float x, float y, float z, float w) {}
...
// Range: 0x802D59C4 -> 0x802D59F8
// this: r3
virtual CBProjector::~CBProjector() {}

// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r31
void CBProjector::CalcProjectionMatrix() {
    // Local variables
    float projScale[4][4]; // r1+0x8
    float projTrans[4][4]; // r1+0x48
    float tmpMat1[4][4]; // r1+0x88
    float tmpMat2[4][4]; // r1+0xC8
}

// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r31
void CBProjector::UpdateOrientationPosition() {
    // Local variables
...
// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r8
void CBProjector::FocusOnActor(struct _TBActorInstance * actInstance /* r4 */, float * offset /* r5 */, int sticky /* r6 */) {
    // Range: 0x802D59F8 -> 0x802D59F8
    inline void bmVanillaVectorCopy(float * dest, const float * src) {}
...
// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r11
void CBProjector::SetFocus(float * focalPoint /* r4 */, int sticky /* r5 */) {
    // Range: 0x802D59F8 -> 0x802D59F8
    inline void bmVanillaVectorCopy(float * dest, const float * src) {}
}
...
// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r11
void CBProjector::SetFocus(float x /* f1 */, float y /* f2 */, float z /* f3 */) {
    // Range: 0x802D59F8 -> 0x802D59F8
    inline void bmVanillaVectorSet(float * dest, float x, float y, float z, float w) {}
}
...
// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r11
void CBProjector::SetPosition(float * pos /* r4 */, int sticky /* r5 */) {
    // Range: 0x802D59F8 -> 0x802D59F8
    inline void bmVanillaVectorCopy(float * dest, const float * src) {}
}
...
// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r11
void CBProjector::SetPosition(float x /* f1 */, float y /* f2 */, float z /* f3 */) {
    // Range: 0x802D59F8 -> 0x802D59F8
    inline void bmVanillaVectorSet(float * dest, float x, float y, float z, float w) {}
}
...
// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r3
void CBProjector::SetOrientation(float * xAngRadians /* r4 */, float * yAngRadians /* r5 */, float * zAngRadians /* r6 */, float dist /* f1 */) {}

// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r31
void CBProjector::SetOrientation(float xAngRadians /* f1 */, float yAngRadians /* f2 */, float zAngRadians /* f3 */, float dist /* f31 */) {}

// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r31
void CBProjector::SetOrientation(float * quatOrientation /* r4 */, float dist /* f1 */, int sticky /* r5 */) {}

// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r31
void CBProjector::SetOrientation(float (* orientation)[4] /* r30 */, float dist /* f1 */, int sticky /* r5 */) {
    // Range: 0x802D59F8 -> 0x802D59F8
    inline void bmGCMatTranspose(float (* mat)[4]) {
        // Local variables
...
// Range: 0xFFFFFFFF -> 0x802D59F8
// this: r31
void CBProjector::SetViewInfo(float xFovVal /* f0 */, float yFovVal /* f31 */, float nearClipVal /* f29 */, float farClipVal /* f28 */) {
    // Range: 0x802D59F8 -> 0x802D59F8
    inline float bmVanillaTanApprox(float val) {}
...
// Range: 0x802D59F8 -> 0x802D5B94
// this: r29
void CBProjector::DrawMaskFrustum(float (* projView)[4] /* r4 */) {
    // Local variables
    struct _TBPrimVertex verts[6]; // r1+0x8
    struct _TBPrimVertex * vp; // r31
    float x; // f29
    float y; // f1
    float z; // f30
    float tmpMat1[4][4]; // r1+0xE0
}

// Range: 0xFFFFFFFF -> 0x802D5B94
// this: r29
void CBProjector::Show() {
    // Local variables
    struct _TBPrimVertex verts[2]; // r1+0x8
    float x; // f25
    float y; // f26
    float z; // f27
    float tmpMat1[4][4]; // r1+0x50
    float projView[4][4]; // r1+0x90

    // Range: 0x802D5B94 -> 0x802D5B94
    inline float bmVanillaSin(float val) {}
...
// Range: 0xFFFFFFFF -> 0x802D5B94
// this: r3
void CBProjector::SetDistance(float _distance /* f1 */) {}

// Range: 0xFFFFFFFF -> 0x802D5B94
// this: r31
CBShadowProjector::CBShadowProjector(enum EBProjectorControl control /* r4 */, int xDim /* r28 */, int yDim /* r27 */, unsigned int flags /* r30 */, int bpp /* r29 */) {
    // Local variables
    int rFlags; // r7
    int density; // r10
}

// Range: 0x802D5B94 -> 0x802D5BE8
// Overrides: CBProjector
// this: r31
CBShadowProjector::~CBShadowProjector() override {}

// Range: 0xFFFFFFFF -> 0x802D5BE8
// this: r3
void CBShadowProjector::SetTarget(unsigned int clear /* r4 */) {}

// Range: 0x802D5BE8 -> 0x802D5C28
// this: r3
virtual void CBShadowProjector::UnSetTarget() {}

// Range: 0xFFFFFFFF -> 0x802D5C28
// this: r31
void CBShadowProjector::PreDrawActorInstance(unsigned int flags /* r30 */) {}

// Range: 0xFFFFFFFF -> 0x802D5C28
// this: r29
void CBShadowProjector::DrawActorInstance(struct _TBActorInstance * actInstance /* r30 */, unsigned int alphaFlags /* r25 */, unsigned int flags /* r26 */) {
    // Local variables
    enum EBActRenderMode oldRenderMode[3]; // r1+0x8
    void * oldRenderParms[3]; // r1+0x18
    int l; // r31
}

// Range: 0xFFFFFFFF -> 0x802D5C28
// this: r31
void CBShadowProjector::PostDrawActorInstance(unsigned int flags /* r4 */) {}

// Range: 0xFFFFFFFF -> 0x802D5C28
// this: r3
void CBShadowProjector::SetShadowDensity(int density /* r4 */) {}

// Range: 0x802D5C28 -> 0x802D5C50
// Overrides: CBProjector
// this: r3
void CBShadowProjector::Enable(int stage /* r4 */) override {}

// Range: 0x802D5C50 -> 0x802D5FA8
// this: r29
void CBShadowProjector::Enable(int stage /* r31 */, enum EBShadowProjectorStyle renderStyle /* r28 */, struct _TBRenderTarget * shadowTarget /* r27 */) {
    // Local variables
    float projView[4][4]; // r1+0x8
    float tmpMat1[4][4]; // r1+0x48
}

// Range: 0x802D5FA8 -> 0x802D5FF0
// Overrides: CBProjector
// this: r30
void CBShadowProjector::SetRecievingGeometryMatrix(float (* m)[4] /* r5 */) override {
    // Local variables
    float tmpMat1[4][4]; // r1+0x8
}

// Range: 0x802D5FF0 -> 0x802D60BC
// Overrides: CBProjector
// this: r30
void CBShadowProjector::Disable(int stage /* r31 */) override {}

// total size: 0x188
struct CBTargetProjector : public CBProjector {
    // Functions
    CBTargetProjector(enum EBProjectorControl control, struct _TBRenderTarget * targetPtr, unsigned int flags);

    // Overrides: CBProjector
    ~CBTargetProjector() override;
    ...
    // Members
    struct _TBRenderTarget * target; // offset 0x184, size 0x4
};
// Range: 0xFFFFFFFF -> 0x802D60BC
// this: r30
CBTargetProjector::CBTargetProjector(enum EBProjectorControl control /* r4 */, struct _TBRenderTarget * targetPtr /* r29 */, unsigned int flags /* r6 */) {}

// Range: 0x802D60BC -> 0x802D60EC
// Overrides: CBProjector
// this: r11
CBTargetProjector::~CBTargetProjector() override {}

// Range: 0x802D60EC -> 0x802D61F8
// Overrides: CBProjector
// this: r31
void CBTargetProjector::Enable(int stage /* r29 */) override {
    // Local variables
    float projView[4][4]; // r1+0x8
    float tmpMat1[4][4]; // r1+0x48
}

// Range: 0x802D61F8 -> 0x802D6240
// Overrides: CBProjector
// this: r30
void CBTargetProjector::SetRecievingGeometryMatrix(float (* m)[4] /* r5 */) override {
    // Local variables
    float tmpMat1[4][4]; // r1+0x8
}

// Range: 0x802D6240 -> 0x802D62CC
// Overrides: CBProjector
// this: r3
void CBTargetProjector::Disable(int stage /* r31 */) override {}

// total size: 0x188
struct CBTextureProjector : public CBProjector {
    // Functions
    CBTextureProjector(enum EBProjectorControl control, struct _TBTexture * texturePtr, unsigned int flags);

    // Overrides: CBProjector
    ~CBTextureProjector() override;
    ...
    void SetTexture(struct _TBTexture * texturePtr);

    // Members
    struct _TBTexture * texture; // offset 0x184, size 0x4
};
// Range: 0xFFFFFFFF -> 0x802D62CC
// this: r29
CBTextureProjector::CBTextureProjector(enum EBProjectorControl control /* r4 */, struct _TBTexture * texturePtr /* r28 */, unsigned int flags /* r30 */) {}

// Range: 0x802D62CC -> 0x802D62FC
// Overrides: CBProjector
// this: r11
CBTextureProjector::~CBTextureProjector() override {}

// Range: 0x802D62FC -> 0x802D648C
// Overrides: CBProjector
// this: r29
void CBTextureProjector::Enable(int stage /* r31 */) override {
    // Local variables
    float projView[4][4]; // r1+0x8
    float tmpMat1[4][4]; // r1+0x48
}

// Range: 0x802D648C -> 0x802D64D4
// Overrides: CBProjector
// this: r30
void CBTextureProjector::SetRecievingGeometryMatrix(float (* m)[4] /* r5 */) override {
    // Local variables
    float tmpMat1[4][4]; // r1+0x8
}

// Range: 0x802D64D4 -> 0x802D6574
// Overrides: CBProjector
// this: r30
void CBTextureProjector::Disable(int stage /* r31 */) override {}

// Range: 0xFFFFFFFF -> 0x802D6574
// this: r3
void CBTextureProjector::SetTile(float uTile /* f1 */, float vTile /* f2 */) {}

// Range: 0xFFFFFFFF -> 0x802D6574
// this: r3
void CBTextureProjector::SetTexture(struct _TBTexture * texturePtr /* r4 */) {}

// Range: 0x802D6574 -> 0x802D65A8
inline virtual CBAnimSplashFragGen::~CBAnimSplashFragGen() {}

// Range: 0x802D65A8 -> 0x802D65DC
// Overrides: CBAnimSplashFX
inline CBAnimSplashFX_Fade::~CBAnimSplashFX_Fade() override {
    // Range: 0x802D65B4 -> 0x802D65CC
    inline virtual CBAnimSplashFX::~CBAnimSplashFX() {}
}

// Range: 0x802D65DC -> 0x802D6610
// Overrides: CBAnimSplashFX
inline CBAnimSplashFX_SlideOn::~CBAnimSplashFX_SlideOn() override {
    // Range: 0x802D65E8 -> 0x802D6600
    inline virtual CBAnimSplashFX::~CBAnimSplashFX() {}
}

// Range: 0x802D6610 -> 0x802D6644
inline virtual CBAnimSplashFX::~CBAnimSplashFX() {}

// Range: 0x802D6644 -> 0x802D6648
inline virtual void CBAnimSplashFX::Enter() {}

// Range: 0x802D6648 -> 0x802D664C
inline virtual void CBAnimSplashFX::Exit() {}
...
CBProjector * bActiveProjector[8]; // size: 0x20, address: 0x80387414
