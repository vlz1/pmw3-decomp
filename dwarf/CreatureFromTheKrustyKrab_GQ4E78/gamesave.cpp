/*
    Compile unit: b:/BlitzSDK/Babel/Common/Src/bInput/gamesave.cpp
    Producer: GNU C++ 2.95.3 SN BUILD v1.62 for Nintendo Gamecube
    Compile directory: b:\BlitzSDK\Babel\GameCube\Src\bInput
    Language: C++
    Code range: 0x8024FA10 -> 0x8024FFF4
    GCC Source File Name Offset: 0x0001B74E
    GCC Source Info Offset: 0x0004E48C
*/
...
// Range: 0x8024FA10 -> 0x8024FA84
void biGameSaveStart(enum EBGameSaveMode loadSave /* r30 */, void * saveData /* r28 */, unsigned short * saveNamePrefix /* r29 */, int saveSize /* r27 */, int flags /* r7 */) {}
...
// Range: 0x8024FA84 -> 0x8024FAE4
enum EBGameSaveStatus biGameSaveGetStatus(struct _TBGameSaveDirEntry * dirEntries /* r7 */, int numDirEntries /* r4 */, int * numFiles /* r9 */, struct _TBGameSaveInfo * saveInfo /* r10 */) {}
...
// Range: 0x8024FAE4 -> 0x8024FFE0
void biGameSaveSetStatus(enum EBGameSaveResponse response /* r3 */, unsigned short * saveName /* r4 */, int deleteFile /* r31 */, struct _TBGameSaveInfo * saveInfo /* r6 */) {}
...
enum EBGameSaveMode bCurrentGameSaveMode; // size: 0x4, address: 0x8047CF64
enum EBGameSaveStatus bCurrentGameSaveStatus; // size: 0x4, address: 0x8047CF60
...
void * bSaveDataPtr; // size: 0x4, address: 0x8047D6FC
unsigned short bSaveDataName[128]; // size: 0x100, address: 0x8042E2D0
unsigned short bSaveNamePrefix[128]; // size: 0x100, address: 0x8042E3D0
int bSaveDataSize; // size: 0x4, address: 0x8047D700
int bDeleteFile; // size: 0x4, address: 0x8047D704
int bGameSaveFlags; // size: 0x4, address: 0x8047D708
unsigned int * bDetectSaveIDs; // size: 0x4, address: 0x8047D70C
int * bDetectSaveResults; // size: 0x4, address: 0x8047D710
int bDetectSaveCount; // size: 0x4, address: 0x8047D714
unsigned short bSaveDescription[32]; // size: 0x40, address: 0x8042E4D0
