/*
    Compile unit: b:/BlitzSDK/Babel/Common/Src/bKernel/heap.cpp
    Producer: GNU C++ 2.95.3 SN BUILD v1.62 for Nintendo Gamecube
    Compile directory: b:\BlitzSDK\Babel\GameCube\Src\bKernel
    Language: C++
    Code range: 0x80246B54 -> 0x802481D4
    GCC Source File Name Offset: 0x0001B561
    GCC Source Info Offset: 0x0004E288
*/
...
// Range: 0xFFFFFFFF -> 0x80246B54
void * operator new(unsigned int size /* r3 */) {}

// Range: 0xFFFFFFFF -> 0x80246B54
void * operator new [](unsigned int size /* r3 */) {}

// Range: 0x80246B54 -> 0x80246B74
void * operator new(unsigned int size /* r3 */, char * file /* r4 */, int line /* r5 */, unsigned short flags /* r6 */) {}

// Range: 0x80246B74 -> 0x80246B94
void * operator new [](unsigned int size /* r3 */, char * file /* r4 */, int line /* r5 */, unsigned short flags /* r6 */) {}

// Range: 0xFFFFFFFF -> 0x80246B94
void operator delete(void * block /* r3 */, char * file /* r4 */, int line /* r5 */, unsigned short flags /* r6 */) {}

// Range: 0x80246B94 -> 0x80246BB4
void operator delete(void * block /* r3 */) {}

// Range: 0xFFFFFFFF -> 0x80246BB4
void operator delete [](void * block /* r3 */, char * file /* r4 */, int line /* r5 */, unsigned short flags /* r6 */) {}

// Range: 0x80246BB4 -> 0x80246BD4
void operator delete [](void * block /* r3 */) {}
...
// Range: 0x80246BD4 -> 0x80246BF4
static struct _TBHeapBlock * GetBlockHeader(void * ptr /* r9 */) {}

// Range: 0x80246BF4 -> 0x80246C04
static void MarkBlock(struct _TBHeapBlock * block /* r3 */) {}

// Range: 0x80246C04 -> 0x80246CB0
int bInitHeap(void * base /* r30 */, unsigned int size /* r3 */) {}

// Range: 0x80246CB0 -> 0x80246DDC
void bShutdownHeap() {
    // Local variables
    struct _TBHeapBlock * block; // r31
    char buf[32]; // r1+0x8
    char buf2[172]; // r1+0x28
    char buf3[16]; // r1+0xD8
}

// Range: 0x80246DDC -> 0x80246EEC
void bkHeapReset() {
    // Local variables
    int l;
}

// Range: 0x80246EEC -> 0x80246F44
void * bkHeapCalloc(unsigned int size /* r30 */, int value /* r29 */, char * file /* r5 */, int line /* r6 */, unsigned short flags /* r7 */) {
    // Local variables
    void * ptr; // r31
}

// Range: 0x80246F44 -> 0x80246FA4
void * bkHeapCallocEx(unsigned int size /* r30 */, int value /* r29 */, char * file /* r5 */, int line /* r6 */, unsigned short flags /* r7 */, char * group /* r8 */, int alignment /* r9 */) {
    // Local variables
    void * ptr; // r31
}

// Range: 0x80246FA4 -> 0x80247070
static void ConnectFreeBlock(struct _TBHeapBlock * block /* r3 */) {
    // Local variables
    struct _TBHeapBlock * freeBlock; // r11
}

// Range: 0xFFFFFFFF -> 0x80247070
static void ClearMemory(void * ptr /* r3 */, unsigned int val /* r4 */, int size /* r5 */) {
    // Local variables
    int i; // r9
    int intCount; // r0
}

// Range: 0x80247070 -> 0x802470E8
static void * SysHeapAlloc(unsigned int size /* r3 */, char * file /* r4 */, int line /* r5 */, unsigned short flags /* r28 */, char * group /* r29 */) {
    // Local variables
    unsigned int adjSize; // r30
    struct _TBHeapBlock * block;
}

// Range: 0x802470E8 -> 0x8024713C
void * bkHeapAlloc(unsigned int size /* r27 */, char * file /* r30 */, int line /* r29 */, unsigned short flags /* r28 */) {}

// Range: 0x8024713C -> 0x8024765C
void * bkHeapAllocEx(unsigned int size /* r29 */, char * file /* r27 */, int line /* r25 */, unsigned short flags /* r24 */, char * group /* r26 */, int alignment /* r28 */) {
    // Local variables
    int reqSize;
    struct _TBHeapBlock * block; // r30
    struct _TBHeapBlock * newBlock; // r31
    unsigned int adjSize; // r7
    unsigned int alignedPtr; // r31

    /* anonymous block */ {
        // Range: 0x802471E8 -> 0x80247274
        unsigned char * newPtr; // r11
    }

    /* anonymous block */ {
        // Range: 0x80247300 -> 0x80247338
        int largest; // r1+0x8
        int sizeFree;
    }

    /* anonymous block */ {
        // Range: 0x80247360 -> 0x80247418
        struct _TBHeapBlock * freeBlock; // r8
    }
}

// Range: 0x8024765C -> 0x802478F0
void bkHeapFree(void * ptr /* r30 */) {
    // Local variables
    struct _TBHeapBlock * block; // r31
    struct _TBHeapBlock * prevBlock;
    struct _TBHeapBlock * nextBlock; // r10
    struct _TBHeapPool * pool;
    int l; // r8
}
...
// Range: 0x802478F0 -> 0x80247CB4
void * bkHeapRealloc(void * ptr /* r28 */, int newSize /* r30 */) {
    // Local variables
    struct _TBHeapBlock * block; // r31
    struct _TBHeapBlock * tmpNext; // r8
    struct _TBHeapBlock * tmpPrev; // r11
    unsigned int adjSize; // r29
    int remainingFree; // r5
    struct _TBHeapBlock * newFreeBlock; // r9
    struct _TBHeapBlock * afterFreeBlock; // r7
    struct _TBHeapBlock * oldFreeBlock; // r8

    /* anonymous block */ {
        // Range: 0x802479F8 -> 0x80247B30
        void * newPtr; // r30
    }

    /* anonymous block */ {
        // Range: 0x80247B68 -> 0x80247C40
        struct _TBHeapBlock * newFreeBlock; // r10
        struct _TBHeapBlock tmpFreeBlock; // r1+0x8
    }
}

// Range: 0x80247CB4 -> 0x80247CDC
int bkHeapGetBlockSize(void * ptr /* r3 */) {
    // Local variables
    struct _TBHeapBlock * block;
}

// Range: 0x80247CDC -> 0x80247CE0
void bkHeapShow(char * group /* r3 */, int pause /* r4 */) {}

// Range: 0xFFFFFFFF -> 0x80247CE0
void bkHeapShowGraphical(char * group /* r3 */, float zoomPos /* f1 */, float zoomFactor /* f2 */, const struct _TBFont * font /* r4 */, int colourMode /* r5 */) {}
...
// Range: 0x80247CE0 -> 0x80247D84
int bkIsHeapBlock(void * ptr /* r3 */) {
    // Local variables
    struct _TBHeapBlock * block; // r3
    struct _TBHeapBlock * prevBlock; // r11
}

// Range: 0xFFFFFFFF -> 0x80247D84
void bkHeapFreeGroup(char * group /* r30 */) {
    // Local variables
    struct _TBHeapBlock * block; // r31
}

// Range: 0xFFFFFFFF -> 0x80247D84
void bkHeapSetBreakAlloc(unsigned int blockId /* r3 */) {}

// Range: 0x80247D84 -> 0x80247DE8
int bkHeapFreeSpace(int * largestFreeBlock /* r3 */) {
    // Local variables
    struct _TBHeapBlock * block; // r11
    int size; // r9
    int max; // r0
}

// Range: 0xFFFFFFFF -> 0x80247DE8
int bkHeapBlocksAllocated(int * peakBlocks /* r3 */) {}

// Range: 0xFFFFFFFF -> 0x80247DE8
int bkHeapBlocksFree() {}

// Range: 0x80247DE8 -> 0x80247E04
char * bGetCurrentGroup() {}

// Range: 0x80247E04 -> 0x80247E3C
int bkHeapGroupPush(const char * const group /* r3 */) {}

// Range: 0x80247E3C -> 0x80247E68
int bkHeapGroupPop() {}

// Range: 0xFFFFFFFF -> 0x80247E68
void bkShowHeapStructure() {
    // Local variables
    struct _TBHeapBlock * block; // r9
    struct _TBHeapBlock * block2; // r9
    int used;
}

// Range: 0x80247E68 -> 0x80247E74
void bkHeapSetLargeBlockThreshold(unsigned int value /* r3 */) {}

// Range: 0x80247E74 -> 0x80247E80
unsigned int bkHeapGetLargeBlockThreshold() {}

// Range: 0x80247E80 -> 0x80247EA0
void bkFreeAligned(void * ptr /* r3 */) {}

// Range: 0xFFFFFFFF -> 0x80247EA0
int bkHeapSize() {}

// Range: 0x80247EA0 -> 0x80247F00
int bkHeapEnablePooling(int enable /* r10 */) {}

// Range: 0x80247F00 -> 0x8024801C
struct _TBHeapPool * bHeapCreatePool(unsigned int size /* r27 */, void * memPtr /* r11 */) {
    // Local variables
    int l; // r30
    struct _TBHeapPool * pool; // r31

    /* anonymous block */ {
        // Range: 0x80247FB0 -> 0x80247FBC
        int largest; // r1+0x8
    }
}

// Range: 0x8024801C -> 0x80248078
void bkHeapActivatePool(struct _TBHeapPool * pool /* r30 */) {}

// Range: 0x80248078 -> 0x8024812C
void bkHeapDeactivatePool(struct _TBHeapPool * pool /* r31 */, int finalise /* r4 */) {
    // Local variables
    unsigned char * newPtr;
}

// Range: 0x8024812C -> 0x802481D4
void bkHeapFreePool(struct _TBHeapPool * pool /* r31 */) {}
...
TBHeap bHeap; // size: 0x974, address: 0x80384530
...
char * moduleNames[15]; // size: 0x3C, address: 0x80384EA4
