/*
    Compile unit: b:/BlitzSDK/Babel/Common/Src/bInput/savemenu.cpp
    Producer: GNU C++ 2.95.3 SN BUILD v1.62 for Nintendo Gamecube
    Compile directory: b:\BlitzSDK\Babel\GameCube\Src\bInput
    Language: C++
    Code range: 0x8024D588 -> 0x8024FA10
    GCC Source File Name Offset: 0x0001B6F6
    GCC Source Info Offset: 0x0004E468
*/
...
// Range: 0x8024D588 -> 0x8024D8EC
char * SaveStatusStr(int status /* r3 */) {
    // Local variables
    char unknownStr[32]; // @ 0x8042C210
}

// Range: 0x8024D8EC -> 0x8024D98C
void bGenerateSaveName(struct _TBSaveMenuInfo * info /* r30 */) {
    // Local variables
    int i;
    char saveName8[256]; // r1+0x8
    int endOfString; // r31
}
...
struct _TBSaveMenuInfo {
    ...
    struct _TBStringTable * stringTable; // offset 0x24, size 0x4
    unsigned int * stringIDs; // offset 0x28, size 0x4
    struct _TBFont * font; // offset 0x2C, size 0x4
    struct _TBFontFormatting * messageFormat; // offset 0x30, size 0x4
    struct _TBFontFormatting * okFormat; // offset 0x34, size 0x4
    struct _TBFontFormatting * cancelFormat; // offset 0x38, size 0x4
    struct _TBFontFormatting * retryFormat; // offset 0x3C, size 0x4
    struct _TBFontFormatting * yesFormat; // offset 0x40, size 0x4
    struct _TBFontFormatting * noFormat; // offset 0x44, size 0x4
    int (* displayFilesCallback)(enum EBSaveMenuDisplayReason, struct _TBSaveMenuFileStatus *, int, void *); // offset 0x48, size 0x4
    void * displayFilesContext; // offset 0x4C, size 0x4
    int (* displayTextCallback)(int, struct _TBStringTableString *, const struct _TBFontFormatting *, int, int, void *); // offset 0x50, size 0x4
    ...
    struct _TBTexture * xboxIcon; // offset 0x6C, size 0x4
    int productCode; // offset 0x70, size 0x4
    void * ps2Icon; // offset 0x74, size 0x4
    int ps2IconSize; // offset 0x78, size 0x4
    struct _TBTexture * gamecubeBanner; // offset 0x7C, size 0x4
    struct _TBTexture * gamecubeIcon; // offset 0x80, size 0x4
...
struct _TBSaveMenuFileStatus {
    // Members
    struct _TBGameSaveDirEntry entry; // offset 0x0, size 0x154
...
// Range: 0x8024D98C -> 0x8024DAD4
static int bPrepareSaveData(int mode /* r3 */, struct _TBSaveMenuInfo * info /* r28 */) {
    // Local variables
    unsigned short * lineBreak; // r30
    int i; // r31
    int n; // r26
}

// Range: 0x8024DAD4 -> 0x8024DBA0
static int saveMenuStart(int mode /* r31 */, void * data /* r4 */, int dataSize /* r6 */) {}

// Range: 0x8024DBA0 -> 0x8024DBC8
int bProcessTextDisplayCallback(int stringType /* r3 */, struct _TBStringTableString * stringTableEntry /* r4 */, const struct _TBFontFormatting * formatting /* r5 */, int status /* r6 */, int count /* r7 */, void * context /* r8 */) {}

// Range: 0x8024DBC8 -> 0x8024DC40
static int bDefaultTextDisplayCallback(int stringType /* r3 */, struct _TBStringTableString * stringTableEntry /* r30 */, const struct _TBFontFormatting * formatting /* r31 */, int status /* r29 */, int count /* r7 */, void * context /* r8 */) {}

// Range: 0x8024DC40 -> 0x8024DDB4
static int bDefaultFileDisplayCallback(enum EBSaveMenuDisplayReason reason /* r3 */, struct _TBSaveMenuFileStatus * fileStatus /* r4 */, int currentSelection /* r24 */, void * context /* r6 */) {
    // Local variables
    unsigned short fileText[256]; // r1+0x10
    char text8[256]; // r1+0x210
    char tmpBuf[64]; // r1+0x310
    struct _TBFontFormatting format; // r1+0x350
    int i; // r31
    char * statusText[3]; // r1+0x370
}

// Range: 0x8024DDB4 -> 0x8024DEF0
int biSaveMenuStart(int mode /* r30 */, struct _TBSaveMenuInfo * info /* r31 */, unsigned int flags /* r5 */) {}

// Range: 0x8024DEF0 -> 0x8024E46C
int biSaveMenuPoll(int userOK /* r29 */, int userCancel /* r28 */, int userRetry /* r24 */, int userCycleRight /* r25 */, int userCycleLeft /* r26 */) {
    // Local variables
    enum EBGameSaveStatus status; // r31
    struct _TBGameSaveScreenText text; // r1+0x8
    int ret; // r27
    struct _TBStringTableString * string; // r3

    /* anonymous block */ {
        // Range: 0x8024DFEC -> 0x8024E110
        int curSimpleStatus; // r30
    }
}
...
// total size: 0x18
struct _TBGameSaveScreenText {
    // Members
    int menuText; // offset 0x0, size 0x4
    int okText; // offset 0x4, size 0x4
    int cancelText; // offset 0x8, size 0x4
    int retryText; // offset 0xC, size 0x4
    int yesText; // offset 0x10, size 0x4
    int noText; // offset 0x14, size 0x4
};
// Range: 0x8024E46C -> 0x8024E894
static int saveMenuPoll_Common(int userOK /* r30 */, int userCancel /* r31 */, enum EBGameSaveStatus status /* r5 */, struct _TBGameSaveScreenText * text /* r6 */) {
    // Local variables
    int cancelButton; // r8
    int actualUserOK;
    int actualUserCancel;
}

// Range: 0x8024E894 -> 0x8024EAC4
static int bExamineDirEntries() {
    // Local variables
    int i; // r28
    int j; // r30
    int mostRecent; // r26
...
// Range: 0x8024EAC4 -> 0x8024EF48
static int saveMenuPoll_Save(int userOK /* r31 */, int userCancel /* r30 */, int userCycleRight /* r29 */, int userCycleLeft /* r28 */, enum EBGameSaveStatus status /* r7 */, struct _TBGameSaveScreenText * text /* r6 */) {}

// Range: 0x8024EF48 -> 0x8024F600
static int saveMenuPoll_Load(int userOK /* r30 */, int userCancel /* r31 */, int userCycleRight /* r29 */, int userCycleLeft /* r28 */, enum EBGameSaveStatus status /* r7 */, struct _TBGameSaveScreenText * text /* r8 */) {
    // Local variables
    int nextHighlight; // r11
    int i; // r11
}

// Range: 0x8024F600 -> 0x8024F8A4
static int saveMenuPoll_Boot(int userOK /* r3 */, int userCancel /* r31 */, enum EBGameSaveStatus status /* r5 */, struct _TBGameSaveScreenText * text /* r6 */) {}

// Range: 0x8024F8A4 -> 0x8024F954
static int saveMenuPoll_Detect(int userOK /* r3 */, int userCancel /* r4 */, enum EBGameSaveStatus status /* r5 */, struct _TBGameSaveScreenText * text /* r6 */) {}

// Range: 0xFFFFFFFF -> 0x8024F954
int biSaveMenuGetLastName(char * name /* r3 */) {}

// Range: 0x8024F954 -> 0x8024FA10
static int saveMenuPoll_Delete(int userOK /* r3 */, int userCancel /* r4 */, enum EBGameSaveStatus status /* r5 */, struct _TBGameSaveScreenText * text /* r6 */) {}
...
enum EBGameSaveStatus bCurrentGameSaveStatus; // size: 0x4
// total size: 0x4C
...
typedef struct _TBGameSaveScreenText TBGameSaveScreenText;
static int saveMode; // size: 0x4, address: 0x8047CF30
static int chosenFile; // size: 0x4, address: 0x8047D6BC
static int dirToDelete; // size: 0x4, address: 0x8047D6C0
static int highlighted; // size: 0x4, address: 0x8047D6C4
static int yesNoSelection; // size: 0x4, address: 0x8047D6C8
static unsigned int optionFlags; // size: 0x4, address: 0x8047D6CC
static TBFontFormatting * menuFormat; // size: 0x4, address: 0x8047D6D0
static TBFontFormatting * okFormat; // size: 0x4, address: 0x8047D6D4
static TBFontFormatting * cancelFormat; // size: 0x4, address: 0x8047D6D8
static TBFontFormatting * retryFormat; // size: 0x4, address: 0x8047D6DC
static TBFontFormatting * yesFormat; // size: 0x4, address: 0x8047D6E0
static TBFontFormatting * noFormat; // size: 0x4, address: 0x8047D6E4
static int prevStatus; // size: 0x4, address: 0x8047CF34
static unsigned short * saveName; // size: 0x4, address: 0x8047CF38
static unsigned short saveNameSingle[128]; // size: 0x100, address: 0x8042C230
static unsigned short multiSaveNames[128][3]; // size: 0x300, address: 0x8042C330
static unsigned short displayNames[128][3]; // size: 0x300, address: 0x8042C630
static TBSaveMenuFileStatus saveFiles[3]; // size: 0x414, address: 0x8042C930
static TBGameSaveInfo gameSaveInfo; // size: 0x4C, address: 0x8042CD44
static TBGameSaveDirEntry cardDirEntries[16]; // size: 0x1540, address: 0x8042CD90
static int cardDirCount; // size: 0x4, address: 0x8047D6E8
static int bGameSaveStatusCount; // size: 0x4, address: 0x8047D6EC
static int justFormatted; // size: 0x4, address: 0x8047CF3C
static int prevSimpleStatus; // size: 0x4, address: 0x8047CF40
void * bSaveDataPtr; // size: 0x4
int bSaveDataSize; // size: 0x4
unsigned int * bDetectSaveIDs; // size: 0x4
int * bDetectSaveResults; // size: 0x4
int bDetectSaveCount; // size: 0x4
unsigned short bSaveDescription[32]; // size: 0x40
int bGameSaveExtraSize; // size: 0x4
unsigned int bDefaultSaveMessageIDs[46]; // size: 0xB8, address: 0x80384EF0
static unsigned int * saveMessageIDs; // size: 0x4, address: 0x8047CF44
static TBStringTable * stringTable; // size: 0x4, address: 0x8047CF48
static TBFont * curFont; // size: 0x4, address: 0x8047CF4C
static int (* fileDisplayCallback)(enum EBSaveMenuDisplayReason, TBSaveMenuFileStatus *, int, void *); // size: 0x4, address: 0x8047CF50
static int (* textDisplayCallback)(int, TBStringTableString *, const TBFontFormatting *, int, int, void *); // size: 0x4, address: 0x8047CF54
static int (* statusChangeCallback)(int, void *); // size: 0x4, address: 0x8047CF58
void * statusChangeContext; // size: 0x4, address: 0x8047D6F0
static void * fileDisplayContext; // size: 0x4, address: 0x8047D6F4
static void * textDisplayContext; // size: 0x4, address: 0x8047D6F8
