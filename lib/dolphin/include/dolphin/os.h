...
WEAK_SYMBOL void OSReport(const char* msg, ...);
WEAK_SYMBOL void OSVReport(const char* msg, va_list list);
WEAK_SYMBOL void OSPanic(const char* file, int line, const char* msg, ...);
...
WEAK_SYMBOL extern int __OSIsGcam;
