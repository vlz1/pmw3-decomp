/*
 * Copyright © 2000-2001 SN Systems Software Limited
* All Rights Reserved
* Description : 
*
*  SN Systems Ltd : File Revision History
*
*  $Archive: /Dolphin/include/va-ppc.h $
*
*  Last Modified 
*  $Date: 5/06/01 11:32 $ by $Author: Bill $
*
*  History:
*
*  $History: va-ppc.h $
 * 
 * *****************  Version 3  *****************
 * User: Bill         Date: 5/06/01    Time: 11:32
 * Updated in $/Dolphin/include
 * Fix multiple va_start()
 * 
 * *****************  Version 2  *****************
 * User: Bill         Date: 11/05/01   Time: 11:44
 * Updated in $/Dolphin/include
 * varargs fixes.
* 
*  $NoKeywords: $
...
/* SN CHANGE MAKE __gnuc_va_list a pointer (was __gnuc_va_list[1]) */
...
/* SN CHANGE - Use compilers "..." support */ 
#define va_start(AP,LASTARG)  (__builtin_next_arg(LASTARG),(AP)[0] = ((struct __va_list_tag *)__builtin_saveregs ())[0])
